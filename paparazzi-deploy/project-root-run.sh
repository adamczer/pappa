...
java -Djava.library.path=./paparazzi-deploy/libs \
    -cp paparazzi-deploy/paparazzi-jni-1.0-SNAPSHOT.jar:paparazzi-deploy/paparazzi-nps-1.0-SNAPSHOT.jar:paparazzi-deploy/paparazzi-airborne-1.0-SNAPSHOT.jar \
