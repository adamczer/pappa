...
public class ArdupilotJniAccelSensor extends JniAccelSensor {
...
//// aquire required vector over jni
        ...
        bodyAccel.setX(ArdupilotBridge.getFdmBodyAccelX());
        bodyAccel.setY(ArdupilotBridge.getFdmBodyAccelY());
        bodyAccel.setZ(ArdupilotBridge.getFdmBodyAccelZ());
//        bodyAccel.setX(0.0);
//        bodyAccel.setY(0.0);
//        bodyAccel.setZ(0.0);
        Vect3<Double> accelero_imu = bodyAccel;
//
