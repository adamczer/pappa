...
//        PprzAlgebraDouble.DOUBLE_VECT3_ROUND(data.getValue());
  /* saturate                                       */
        ...
        rotations.setX(ArdupilotBridge.getFdmBodyInertialRotVelP());
        rotations.setY(ArdupilotBridge.getFdmBodyInertialRotVelQ());
        rotations.setZ(ArdupilotBridge.getFdmBodyInertialRotVelR());
