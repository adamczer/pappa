...
public class AttitudeRef<T extends Number> {
    ...
    public static AttitudeRef<Integer> getIntegerFromJni() {
        ...
        ret.saturation.max_accel.p = NativeTasks.getAttitudeRefSaturationMaxAccelP();
        ret.saturation.max_accel.q = NativeTasks.getAttitudeRefSaturationMaxAccelQ();
        ret.saturation.max_accel.r = NativeTasks.getAttitudeRefSaturationMaxAccelR();
        ret.saturation.max_rate = Rates.newInteger();
        ret.saturation.max_rate.p = NativeTasks.getAttitudeRefSaturationMaxRateP();
        ret.saturation.max_rate.q = NativeTasks.getAttitudeRefSaturationMaxRateQ();
        ret.saturation.max_rate.r = NativeTasks.getAttitudeRefSaturationMaxRateR();
        return ret;
    }
